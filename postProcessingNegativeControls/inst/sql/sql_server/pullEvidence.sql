...
CREATE INDEX IDX_EVIDENCE_CONCEPT_OF_INTEREST_CONCEPT_ID_OUTCOME_OF_INTEREST_CONCEPT_ID ON @storeData (CONCEPT_OF_INTEREST_CONCEPT_ID, OUTCOME_OF_INTEREST_CONCEPT_ID);
