...
INSERT INTO @tableName (SOURCE_ID, SOURCE_CODE_1, SOURCE_CODE_TYPE_1, SOURCE_CODE_NAME_1, CONCEPT_ID_1, RELATIONSHIP_ID,
	SOURCE_CODE_2, SOURCE_CODE_TYPE_2, SOURCE_CODE_NAME_2, CONCEPT_ID_2, UNIQUE_IDENTIFIER, UNIQUE_IDENTIFIER_TYPE,
...
SELECT 'AEOLUS' AS SOURCE_ID,
	s.DRUG_CONCEPT_ID AS SOURCE_CODE_1,
	...
	s.OUTCOME_CONCEPT_ID AS SOURCE_CODE_2,
	...
	ct.COUNT_C,
	ct.COUNT_D
FROM @sourceSchema.dbo.standard_drug_outcome_statistics s
	LEFT OUTER JOIN @sourceSchema.dbo.CONCEPT c
		ON c.CONCEPT_ID = s.DRUG_CONCEPT_ID
	LEFT OUTER JOIN @sourceSchema.dbo.CONCEPT c2
		ON c2.CONCEPT_ID = s.OUTCOME_CONCEPT_ID
	LEFT OUTER JOIN @sourceSchema.dbo.standard_drug_outcome_contingency_table ct
