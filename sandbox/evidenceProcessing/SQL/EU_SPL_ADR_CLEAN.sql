...
INSERT INTO @fqntableName (SOURCE_ID, SOURCE_CODE_1,
	...
	UNIQUE_IDENTIFIER, UNIQUE_IDENTIFIER_TYPE, SOC, HLGT, HLT, LLT, AGE_GROUP,
...
SELECT
	...
	POST_MARKETING,
	COMMENT
FROM @sourceSchema.EU_PRODUCT_LABELS pl;

CREATE INDEX IDX_UNIQUE_@tableName_UNIQUE_IDENTIFIER_SOURCE_CODE_1_SOURCE_CODE_2 ON @fqntableName (UNIQUE_IDENTIFIER, SOURCE_CODE_1, SOURCE_CODE_2);
