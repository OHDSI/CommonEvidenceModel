...
CREATE TABLE SPL_MAP (
	SOURCE_CODE            	char(40) NULL,
	SOURCE_VOCABULARY_ID   	char(44) NULL,
	SOURCE_CODE_DESCRIPTION	text NULL,
	TARGET_CONCEPT_ID      	char(44) NULL,
	TARGET_VOCABULARY_ID   	char(44) NULL,
	MAPPING_TYPE           	char(40) NULL,
	PRIMARY_MAP            	char(2) NULL,
	VALID_START_DATE       	date NULL,
	VALID_END_DATE         	date NULL,
	INVALID_REASON         	char(2) NULL
	)'
	AS GENERATE_SQL
UNION ALL
SELECT 'GO
INSERT INTO SPL_MAP(SOURCE_CODE, SOURCE_VOCABULARY_ID, SOURCE_CODE_DESCRIPTION, TARGET_CONCEPT_ID, TARGET_VOCABULARY_ID, MAPPING_TYPE, PRIMARY_MAP, VALID_START_DATE, VALID_END_DATE, INVALID_REASON)
  VALUES(''' + SOURCE_CODE + 
  ''', ''' + SOURCE_VOCABULARY_ID +
  ''', ''' + REPLACE(SOURCE_CODE_DESCRIPTION,',','/,') +
  ''', ''' + CAST(TARGET_CONCEPT_ID AS VARCHAR) + 
  ''', ''' + TARGET_VOCABULARY_ID + 
  ''', ''1970-01-01'', ''2099-12-31'', ''|'')' AS GENERATE_SQL
FROM CTE_VOCAB_MAP
WHERE SOURCE_VOCABULARY_ID IN ('SPL')
